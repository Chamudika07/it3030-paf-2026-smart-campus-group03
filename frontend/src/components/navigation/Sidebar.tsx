...
const links = [
  ...
  { to: "/admin", label: "Admin", roles: ["ADMIN"] as UserRole[], icon: <path d="M12 3l7 4v5c0 4.25-2.55 8.09-6.46 9.73-.35.15-.53.22-.54.22-.01 0-.19-.07-.54-.22C7.55 20.09 5 16.25 5 12V7l7-4Zm0 5.2a2.8 2.8 0 1 0 0 5.6 2.8 2.8 0 0 0 0-5.6Z" strokeLinecap="round" strokeLinejoin="round" /> }
];
      ...
      >
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
          ...
          <p className="mt-2 text-sm text-slate-300">
            Manage resources, bookings, tickets, notifications, and role-based campus operations.
          </p>
        </div>
